...
const RectangleShape: FC<CircleShapeProps> = ({
  ...
  const plusSize = useSharedValue(SIZE * 1.01);
  ...
  useAnimatedReaction(
    ...
    ({ offsetXPosition, offsetYPosition }) => {
      ...
      textIdPositionY.value = innerY.value + 85;

      textIdPositionActiveX.value = innerX.value + 10;
      textIdPositionActiveY.value = innerY.value + 75;

      textNamePositionX.value = innerX.value - 8;
      textNamePositionY.value = innerY.value + 104;
    },
    []
  );
